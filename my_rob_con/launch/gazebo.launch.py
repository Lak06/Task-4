...
def generate_launch_description():
    ...
    bot1 = os.path.join(pkg_dir, "urdf", "/home/lak02/ros2_ws/src/my_rob_con/urdf/rob1.urdf")
    bot2= os.path.join(pkg_dir, "urdf", "/home/lak02/ros2_ws/src/my_rob_con/urdf/rob2.urdf")
